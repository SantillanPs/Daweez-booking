-- ==========================================
-- Fix booking RPC room_id type (varchar, not uuid)
-- Supabase PostgreSQL Migration
--
-- bookings.room_id is VARCHAR and holds legacy ids like 'room-1', but the
-- RPCs declared v_room_id as UUID. Every book_booking/update_booking call
-- crashed with "invalid input syntax for type uuid" (room) or a varchar=uuid
-- operator error (venue), which is why Supabase writes were silently falling
-- back to localStorage. Fix: treat room_id as TEXT throughout.
-- ==========================================
