      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="flex items-center gap-1 bg-page p-1 rounded-lg border border-soft/70">
          ...
          <input
            ...
            className="bg-card border border-soft text-main text-xs px-1.5 py-1 rounded-md outline-none font-mono focus:ring-1 focus:ring-gold-500 focus:border-gold-500 cursor-pointer w-[115px] text-center"
          />
          ...
          <button onClick={onThisMonth} className="text-xs font-semibold text-gold-700 px-2 py-1 hover:bg-card hover:shadow-sm rounded-md transition-all cursor-pointer">
            This month
          </button>
        </div>
